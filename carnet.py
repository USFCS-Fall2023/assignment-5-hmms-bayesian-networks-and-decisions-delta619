...
cpd_gas = TabularCPD(variable="Gas", variable_card=2,
                     values=[[0.40], [0.60]],
...
cpd_starts = TabularCPD(variable="Starts",
                        variable_card=2,
...
# Add CPD for KeyPresent
cpd_keypresent = TabularCPD(variable="KeyPresent", variable_card=2,
                           values=[[0.7], [0.3]],
                           state_names={"KeyPresent": ["yes", "no"]}
                          )

# Add CPDs to model
car_model.add_cpds(cpd_battery, cpd_gas, cpd_radio, cpd_ignition, cpd_starts, cpd_moves, cpd_keypresent)
